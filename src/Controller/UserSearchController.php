...
class UserSearchController extends AbstractController
{
     ...
     */
    #[Route("/search/users", name: "resa_search_users", methods: ["GET", "POST"])]
     ...
     */
    #[Route("/autocomplete/candidat", name: "resa_autocomplete_candidat", methods: ["GET"])]
