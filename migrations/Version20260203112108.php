 ...
 */
final class Version20260203112108 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE em_uniquement em_uniquement TINYINT(1) DEFAULT NULL COMMENT \'Simule, en DEV, un utilisateur n\'\'ayant accès qu\'\'aux véhicules Etat-Major\'');
    }
}
