 ...
 */
final class Version20260317135352 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE vehicule CHANGE created_at created_at DATETIME NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE vehicule CHANGE created_at created_at DATETIME DEFAULT NULL');
    }
}
