 ...
 */
final class Version20260223123708 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, vehicule_id INT NOT NULL, statut_id INT NOT NULL, type_demande_id INT DEFAULT NULL, date_debut DATE NOT NULL, heure_debut VARCHAR(5) NOT NULL, date_fin DATE NOT NULL, heure_fin VARCHAR(5) NOT NULL, user VARCHAR(8) NOT NULL, created_at DATETIME NOT NULL, observation VARCHAR(255) DEFAULT NULL, demandeur VARCHAR(8) DEFAULT NULL, message_valideur VARCHAR(255) DEFAULT NULL, observation_valideur VARCHAR(255) DEFAULT NULL, INDEX IDX_42C849554A4A3511 (vehicule_id), INDEX IDX_42C84955F6203804 (statut_id), INDEX IDX_42C849559DEA883D (type_demande_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, nigend VARCHAR(8) NOT NULL, unite VARCHAR(8) NOT NULL, profil VARCHAR(25) DEFAULT NULL, departement INT DEFAULT NULL, mail VARCHAR(255) DEFAULT NULL, banned TINYINT(1) DEFAULT NULL, em_uniquement TINYINT(1) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE vehicule (id INT AUTO_INCREMENT NOT NULL, genre_id INT NOT NULL, categorie_id INT DEFAULT NULL, carburant_id INT DEFAULT NULL, transmission_id INT DEFAULT NULL, unite_id INT DEFAULT NULL, restriction_id INT DEFAULT NULL, marque VARCHAR(255) NOT NULL, modele VARCHAR(255) NOT NULL, motorisation VARCHAR(25) DEFAULT NULL, finition VARCHAR(25) DEFAULT NULL, controle_technique DATE DEFAULT NULL, nb_places INT DEFAULT NULL, immatriculation VARCHAR(9) NOT NULL, serigraphie TINYINT(1) NOT NULL, couleur_vignette VARCHAR(8) NOT NULL, observation VARCHAR(1024) DEFAULT NULL, departement INT DEFAULT NULL, created_at DATETIME NOT NULL, INDEX IDX_292FFF1D4296D31F (genre_id), INDEX IDX_292FFF1DBCF5E72D (categorie_id), INDEX IDX_292FFF1D32DAAD24 (carburant_id), INDEX IDX_292FFF1D78D28519 (transmission_id), INDEX IDX_292FFF1DEC4A74AB (unite_id), INDEX IDX_292FFF1DE6160631 (restriction_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
